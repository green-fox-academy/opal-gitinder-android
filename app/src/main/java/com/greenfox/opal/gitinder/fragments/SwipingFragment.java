  ...
  public View onCreateView(LayoutInflater inflater, @Nullable final ViewGroup container,
    ...
    flingAdapterView.setFlingListener(new SwipeFlingAdapterView.onFlingListener() {
      ...
      public void onLeftCardExit(Object o) {
        ...
        onSwipingRequest(preferences.getString(LoginActivity.X_GITINDER_TOKEN, null), currentProfile.getLogin(), Direction.LEFT);
      }
      ...
      public void onRightCardExit(Object o) {
        ...
        Profile currentProfile = (Profile) o;
        onSwipingRequest(preferences.getString(LoginActivity.X_GITINDER_TOKEN, null), currentProfile.getLogin(), Direction.RIGHT);
      }
      ...
      public void onAdapterAboutToEmpty(int i) {
        ...
        Log.d("dev", "EMPTY");
        if (i <= 3) {
          onListRequest(preferences.getString(LoginActivity.X_GITINDER_TOKEN, null), 0);
        }
        if (i <= 0) {
    ...
    buttonNope.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        if (!adapter.isEmpty()) {
          Log.d("dev", Direction.LEFT.toString());
          onSwipingRequest(preferences.getString(LoginActivity.X_GITINDER_TOKEN, null), adapter.getItem(0).getLogin(), Direction.LEFT);
          adapter.remove(adapter.getItem(0));
          adapter.notifyDataSetChanged();
    ...
    buttonLike.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        if (!adapter.isEmpty()) {
          Log.d("dev", Direction.RIGHT.toString());
          onSwipingRequest(preferences.getString(LoginActivity.X_GITINDER_TOKEN, null), adapter.getItem(0).getLogin(), Direction.RIGHT);
          adapter.remove(adapter.getItem(0));
          adapter.notifyDataSetChanged();
          flingAdapterView.removeAllViewsInLayout();
        }
