...
public class MessageAdapter extends ArrayAdapter<ExtendedMessage> {

  public MessageAdapter(Context context, ArrayList<ExtendedMessage> message) {
  ...
  public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
    ExtendedMessage current = getItem(position);
    ...
    username.setText(current.getFrom() + " : ");
